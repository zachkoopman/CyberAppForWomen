...
<head runat="server">
  ...
  <style>
    ...
    *{box-sizing:border-box;}
    html, body{margin:0;
               font-family:'Lato',sans-serif;background:var(--bg);color:var(--ink);
               max-width:100%;overflow-x:hidden;line-height:1.55;
    ...
    .btn-primary{background:linear-gradient(135deg,var(--fia-pink),var(--fia-blue));
                 color:#fff;

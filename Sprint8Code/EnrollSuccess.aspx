  ...
  <style>
    ...
    *{ box-sizing:border-box; } 
    ...
    body{ margin:0; 
          ...
          color:var(--ink); background:var(--page-grad);
          line-height:1.55;
    }
    .wrap{ min-height:100vh; 
           display:grid; 
           place-items:center; padding:24px 16px; }
    .card{
    ...
    .sub{ color:var(--muted); margin:2px 0 18px 0; font-size:.95rem;}
    ...
    .v{ color:#0f172a; flex:1; word-break:break-word;}
    ...
    .btn{
      ...
      padding:14px 16px; border-radius:14px; font-weight:600; font-family:Poppins;
      border:1px solid transparent; cursor:pointer; width:100%;
      box-shadow:0 2px 0 rgba(0,0,0,.05); text-align:center;
    }
    ...
    .footnote{ color:var(--muted); margin-top:8px; font-size:.9rem;}

    /* MOBILE OPTIMIZATION */
    @media (max-width:430px){
        .card{padding:22px 18px;}
        h1{font-size:1.15rem;}
        .k{width:100%;min-width:0;}

...
<head runat="server">
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* ---------- Question ---------- */
    .q{font-size:1.15rem;margin:6px 0 14px;word-break:break-word;}
    ...
    .opts label{
      display:block;margin:10px 0;padding:16px 16px;
    ...
    .alert{
      margin-top:8px;padding:14px;border-radius:12px;border:1px solid;
    ...
    .btn{
      padding:12px 18px;border-radius:12px;border:0;background:var(--fia-blue);color:#fff;cursor:pointer;

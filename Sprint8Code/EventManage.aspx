...
<head runat="server">
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{margin:0;font-family:Lato,Arial,sans-serif;background:linear-gradient(135deg,#fff,#f9fbff);overflow-x:hidden;line-height:1.5;}
    ...
    /* Buttons */
    .btn{border:0;border-radius:12px;padding:12px 18px;font-weight:700;font-family:Poppins;cursor:pointer;min-height:44px;}
    .btn.small{padding:8px 12px;font-size:.8rem;min-height:40px;}
    ...
    th,td{padding:8px;border-bottom:1px solid #f0f3f9;text-align:left;font-size:.9rem;white-space:nowrap;}
    th {font-family:Poppins;font-size:.85rem;color:var(--muted);}
    ...
    .helper-filters{margin-bottom:8px;display:flex;flex-wrap:wrap;gap:10px;align-items:center;font-size:.9rem}

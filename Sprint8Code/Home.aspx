...
<head runat="server">
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .subchips{ display:flex; align-items:center; gap:8px; flex-wrap:wrap; row-gap:6px;}
    ...
    .title{ font-family:Poppins; font-weight:600; margin:0; font-size:1.06rem; line-height:1.35; word-break:break-word;}
    ...
    .helper-chip{ border:1px solid rgba(240,106,169,.25); background:linear-gradient(180deg,#fff,#fff7fb); max-width:100%;flex-wrap:wrap;}

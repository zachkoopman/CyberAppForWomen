  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    @media (max-width:720px){
      .rv-hero{flex-direction:column; gap:12px;}
    }

    /* MOBILE OPTIMIZATION */
    @media (max-width:430px){
        .wrap{padding:18px 14px 26px;}
        .rv-title{font-size:1.25rem;}
        .rv-sub{font-size:0.88rem;}
        .rv-toolbar{flex-direction:column;align-items:flex-start;gap:8px;}
        .rv-fallback-link{width:100%;justify-content:center;}
        .rv-frame{height:70vh;}

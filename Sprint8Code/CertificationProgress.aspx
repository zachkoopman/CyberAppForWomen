...
<head runat="server">
  ...
  resize:vertical;
    ...
    @media (max-width:720px){
        .cert-hero{flex-direction:column;align-items:flex-start;}
    ...
    @media (max-width:430px){
        ...
        .cert-sub{font-size:0.9rem;}
        .req-card{padding:14px;}
        .module-pill{flex-direction:column;align-items:flex-start;gap:6px;}
        .req-item-row{flex-direction:column;gap:2px;}
        .resource-confirm-btn{width:100%;}

...
.chip-brand:hover{
    box-shadow:0 0 0 6px var(--ring), 0 12px 26px rgba(42,153,219,.22);
        ...
        @media (max-width:520px){
            ...
            .kv .k, .kv .v{ font-size:1rem; }
            .pill{ width:100%; justify-content:center; padding:12px 0; font-size:1rem; }
                ...
                <div class="grid-2">
                    <div class="card">
                        ...
                        <div class="kv">
                            ...
                            <div class="v">
                                <a class="pill" href="tel:+33744745040">+33 7 44 74 50 40</a>
                            </div>

                            <div class="k">Email</div>
                            <div class="v">
                                <a class="pill" href="mailto:fia@feminineintelligence.agency" >fia@feminineintelligence.agency</a>
                            </div>
                        </div>
                    </div>

...
<head runat="server">
  ...
  <style>
    ...
    *{box-sizing:border-box}
    body{margin:0;padding:0;overflow-x:hidden;font-family:Lato,Arial,sans-serif;background:linear-gradient(135deg,#fff,#f9fbff);line-height:1.5;}

    /* ========== Centered card wrapper ========== */
    .wrap{min-height:100vh;display:grid;place-items:center;padding:clamp(16px,4vw,24px);}
    ...
    h1{font-family:Poppins,sans-serif;font-size:clamp(1.3rem,2.8vw,1.5rem);margin:0}
    ...
    /* ========== Form fields ========== */
    label{font-weight:600;font-family:Poppins;font-size:.95rem;display:block;margin-bottom:4px;}
    input[type=text],input[type=email],input[type=password]{
      width:100%;padding:14px 16px;border-radius:12px;border:1px solid #e5e7eb; font-size:1rem; min-height:44px;
    }
    input:focus{outline:0;box-shadow:0 0 0 5px var(--ring);border-color:var(--fia-blue)}

    /* ========== Consent box ========== */
    .consent{background:#f6f7fb;border:1px solid #e8eef7;border-radius:12px;padding:14px;margin-top:10px}
    .row{display:flex;gap:10px;align-items:flex-start}
    .row input{margin-top:4px;transform:scale(1.1);}

    /* ========== Buttons row ========== */
    .btnrow{display:flex;gap:12px;margin-top:18px;flex-wrap:wrap}
    .btn{border:0;border-radius:12px;padding:14px 10px;font-weight:700;font-family:Poppins;cursor:pointer;min-height:44px;}

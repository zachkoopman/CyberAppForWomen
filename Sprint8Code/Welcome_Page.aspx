...
<head runat="server">
    ...
    box-shadow:0 0 0 6px var(--ring), 0 12px 26px rgba(42,153,219,.22);
        ...
        @media (max-width:430px) {
            .hero{ padding:20px 16px; grid-template-columns:1fr; }
            .grid{ grid-template-columns:repeat(2,1fr); grid-auto-rows:100px; gap:8px; }
            .panel{ flex-direction:column; align-items:stretch; padding:16px; gap:12px; }
            .btnrow{ flex-direction:column; gap:12px; }
            .chip{ font-size:1rem; padding:12px 16px; }
            .brand h1{ font-size:1rem; line-height:1.2; }

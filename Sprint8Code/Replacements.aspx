...
<head runat="server">
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    body{ margin:0; max-width:100%;overflow-x:hidden;font-family:Lato, Arial, sans-serif; color:var(--ink); background:var(--page-grad); line-height:1.55;}
    ...
    .badge{ width:38px; height:38px; border-radius:12px; background:linear-gradient(135deg, var(--fia-pink), var(--fia-blue)); display:grid; place-items:center; color:#fff; font-family:Poppins; flex-shrink:0;}

    h1{ font-family:Poppins; margin:0 0 6px 0; font-size:1.28rem; word-break:break-word;}
    .sub{ color:var(--muted); margin:0 0 18px 0; word-break:break-word;}
    ...
    .title{ font-family:Poppins; font-weight:600; margin:0; font-size:1.02rem; word-break:break-word;}
    .meta{ color:var(--muted); font-size:.92rem; line-height:1.45; word-break:break-word;}
    .cta{ display:flex; gap:8px; margin-top:6px; flex-wrap:wrap;}
    .btn{
      appearance:none; border:none; cursor:pointer;
      padding:12px 14px; border-radius:12px; font-weight:600; font-family:Poppins;
      box-shadow:0 2px 0 rgba(0,0,0,.04); min-height:44px;
    }
    ...
    .link{ color:var(--fia-blue); text-decoration:none; border-bottom:1px dashed #cfe8fb; padding-bottom:1px; display:inline-block; min-height:44px; line-height:44px;}

...
<head runat="server">
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    /* ---------- Notifications (visual test examples only) ---------- */
    .notify-stack{ display:flex; flex-direction:column; gap:10px; margin:12px 0 14px 0; }
    .notify{
      position:relative;
      border-radius:18px;
      border:1px solid var(--card-border);
      background:#fff;
      box-shadow:0 10px 26px rgba(42,153,219,.08);
    ...
    .notify::before{
      ...
      width:7px;
      background:linear-gradient(180deg, var(--fia-blue), var(--fia-teal));
      opacity:.95;
    }
    .notify.pink::before{
    ...
    .notify-badge .dot{
      ...
      box-shadow:0 0 0 4px rgba(42,153,219,.14);
      display:inline-block;
    }
    .notify.pink .notify-badge{
      border-color: rgba(240,106,169,.22);
      background:linear-gradient(180deg,#fff7fb,#ffffff);
      color:#7a103a;
    }
    .notify.pink .notify-badge .dot{
      background:var(--fia-pink);
      box-shadow:0 0 0 4px rgba(240,106,169,.14);
    }
    ...
    /* CTA link button that looks like a button (no logic) */
    .notify-cta{
      display:inline-flex;
      align-items:center;
    ...
    .notify-cta:focus{ outline:none; box-shadow:0 0 0 4px var(--ring); }

    .notify-cta.secondary{
      background:#fff;
      color:var(--fia-blue);
    ...
    .helper-chip strong { color: var(--fia-blue) !important; }
    ...
    /* NEW: Swap button (FIA branded, clean) */
    .btn-swap{
      background:linear-gradient(135deg, var(--fia-teal), var(--fia-blue));
      color:#fff;
      border:1px solid rgba(42,153,219,.18);
    }
    .btn-swap:hover{
      box-shadow:0 10px 22px rgba(69,195,179,.18);
    }
    ...
    .tags-wrap{ border-radius:12px; padding:12px 14px; gap:0; }
    ...
    .tags-wrap [id$="FilterTags"] > span{ padding:6px 10px; margin:0 !important; }
    .tags-wrap span{
      display:inline-flex;
      align-items:center;
      gap:6px;
    ...
    .conversation-title{ font-family:Poppins; font-weight:600; font-size:.98rem; }
    .conversation-meta{ font-size:.85rem; color:var(--muted); }
  </style>
...
<body>
  <form id="form1" runat="server">
    <div class="wrap">
      ...
      <!-- ========================================================= -->
      <!-- EXAMPLE NOTIFICATIONS (VISUAL TEST ONLY, NO LOGIC)         -->
      <!-- ========================================================= -->
      <div class="notify-stack" aria-label="In-app notifications">
        <!-- #190 example: upcoming session (<4 hours) -->
        <div class="notify" role="status" aria-live="polite">
          <div class="notify-head">
            <div>
              <p class="notify-title">Upcoming session starts soon</p>
              <p class="notify-meta">
                <strong>Phishing &amp; Email Safety</strong><br />
                Today at <strong>2:30 PM</strong> (in about <strong>1 hour 45 minutes</strong>)<br />
                Location: <strong>Zoom room link available</strong>
              </p>
            </div>
            <span class="notify-badge"><span class="dot"></span>Starts in &lt; 4 hours</span>
          </div>

          <div class="notify-actions">
            <a class="notify-cta" href="#">View session details</a>
            <a class="notify-cta secondary" href="#">Open room link</a>
            <span class="notify-small">Reminder: room links may appear closer to start time.</span>
          </div>
        </div>

        <!-- #192 example: helper reply notification -->
        <div class="notify pink" role="status" aria-live="polite">
          <div class="notify-head">
            <div>
              <p class="notify-title">New message from your Helper</p>
              <p class="notify-meta">
                <strong>Helper: Maya R.</strong><br />
                Topic: <strong>Password manager setup</strong><br />
                “I can help you pick one and get it installed. Are you on iPhone or Android?”
              </p>
            </div>
            <span class="notify-badge"><span class="dot"></span>1 unread</span>
          </div>

          <div class="notify-actions">
            <a class="notify-cta" href="#">Open chat thread</a>
            <a class="notify-cta secondary" href="#">Mark as read</a>
            <span class="notify-small">This clears after you view the thread.</span>
          </div>
        </div>
      </div>
      ...
      <!-- ========================================================= -->
      <!-- EXAMPLE MY SESSION CARD (ALWAYS VISIBLE, VISUAL TEST ONLY) -->
      <!-- This ensures you see the Swap button even if MySessionsWrap is hidden -->
      <!-- ========================================================= -->
      <div class="section">
        <h2 class="section-title">My Sessions (Example)</h2>
        <div class="fia-sessions-grid">
          <div class="card">
            <div class="card-sec">
              <h3 class="title">Lock Down Your Phone</h3>
            </div>
            ...
            <div class="card-sec">
              <div class="line">
                ...
                <span class="value">Sun, Nov 16 • 5:30 PM</span>
              </div>
            ...
            <!-- Swap button is cleanly placed next to Unenroll (visual only) -->
            <div class="card-sec">
              <div class="cta-row">
                <button type="button" class="btn btn-swap">Swap Session</button>
                <button type="button" class="btn btn-pink">Unenroll</button>
                <button type="button" class="btn btn-ghost">Mark as Complete</button>
              </div>
              <div class="hint" style="padding-left:0; margin-top:10px;">
                Swap lets you pick a different eligible time for the same microcourse.
              </div>
            </div>
          </div>
        </div>
          ...
          <asp:Repeater ID="MySessionsRepeater" runat="server">
            ...
            <ItemTemplate>
              <div class="card">
                ...
                <div class="card-sec">
                  <div class="cta-row">
                    <!-- NEW: Swap button (visual; wire later) -->
                    <button type="button" class="btn btn-swap">Swap Session</button>

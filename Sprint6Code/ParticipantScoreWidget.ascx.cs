        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (res == null)
                {
                    ...
                    QuizStatusLabel.InnerText = "PENDING";
                    QuizStatusLabel.Style["background-color"] = "#f3f4f6";
                    QuizStatusLabel.Style["color"] = "#6b7280";
                ...
                QuizStatusLabel.InnerText = "COMPLETED ✅";
                QuizStatusLabel.Style["background-color"] = "#d1fae5"; // Light Green
                QuizStatusLabel.Style["color"] = "#065f46"; // Dark Green

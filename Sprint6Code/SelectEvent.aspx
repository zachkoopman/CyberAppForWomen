  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    /* =========================
       ...
       ========================= */
    .notif{
      border:1px solid rgba(240,106,169,.35);
      background:
        radial-gradient(900px 220px at 10% 0%, rgba(240,106,169,.12), transparent 60%),
        radial-gradient(900px 220px at 95% 80%, rgba(42,153,219,.10), transparent 60%),
        rgba(240,106,169,.06);
    ...
    .notifIcon{
      ...
      font-weight:800;
      letter-spacing:.2px;
      box-shadow:0 12px 22px rgba(240,106,169,.18);
      flex:0 0 auto;
      margin-top:2px;
    }
    ...
    .notifBtn:focus{ box-shadow:0 0 0 6px var(--ring); }
    .notifBtn:hover{ transform:translateY(-1px); }

    .notifPrimary{
      color:#fff;
      background:linear-gradient(135deg,var(--fia-pink),var(--fia-blue));
      box-shadow:0 12px 24px rgba(240,106,169,.18);
    }
    .notifGhost{
      background:#fff;
      border:2px solid rgba(240,106,169,.45);
      color:#8a1f53;
    }
    .mutedLine{
      margin-top:6px;
    ...
    <div class="wrap">
      <div class="card">
        ...
        <div class="content">
          ...
          <!-- =========================================================
               NEW: "New events added" notification (realistic fake data)
               ========================================================= -->
          <div class="notif" role="status" aria-live="polite">
            ...
            <div class="notifMain">
              <div class="notifTop">
                <div class="notifTitle">New events added since your last visit</div>
                <div class="pill">2 new</div>
              </div>

              <div class="notifBody">
                We added <strong>Spring Cyberfair Week</strong> and <strong>Resume + LinkedIn Security Clinic</strong> for
                <strong>Arizona State University</strong>. Use “View new” to jump to the latest events.
              </div>

              <div class="notifActions">
                <!-- Fake action buttons: keep them as anchors for the mock UI -->
                <a class="notifBtn notifPrimary" href="#EventSelect">View new</a>
                <a class="notifBtn notifGhost" href="#EventSelect">Highlight new</a>
              </div>

              <div class="mutedLine">
                Last checked: Feb 10, 2026 at 1:12 PM.
              </div>
            </div>
          </div>

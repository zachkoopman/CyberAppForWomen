...
<form id="form1" runat="server">
  <div class="wrap">
    ...
    <div class="card">
      ...
      <!-- Session Filters -->
      <asp:Panel ID="SessionFilterPanel" runat="server" BorderStyle="margin:15 px 0;">
          <asp:TextBox ID="TxtSearch" runat="server" Placeholder="Search by course title or helper" Width="200px" />
          <asp:DropDownList ID="DdlMicrocourse" runat="server" Width="180px">
             <asp:ListItem Text="All Microcourses" Value="" />
             <%-- Options will be bound from microcourses.xml --%>
          </asp:DropDownList>
          <asp:DropDownList ID="DdlTimeWindow" runat="server" Width="150px">
              <asp:ListItem Text="Any Time" Value="" />
          ...
          <asp:Button ID="BtnFilterSessions" runat="server" Text="Filter" OnClick="BtnFilterSessions_Click" />
